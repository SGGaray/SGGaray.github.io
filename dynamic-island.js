...
const DynamicIsland = ({
  ...
  const LINKS = [{
    ...
    icon: hov => /*#__PURE__*/_jsxDEV(GithubMark, {
      size: 15,
      fill: accent,
      style: {
        display: 'block',
  ...
  return /*#__PURE__*/_jsxDEV("div", {
    ...
    children: /*#__PURE__*/_jsxDEV("div", {
      ...
      children: [LINKS.map((link, i) => /*#__PURE__*/_jsxDEV("a", {
        href: link.href,
        target: "_blank",
        ...
        children: [link.icon(hoveredIdx === i), /*#__PURE__*/_jsxDEV("span", {
          style: {
