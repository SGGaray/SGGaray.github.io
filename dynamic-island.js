(function (global, factory) {
  ...
  const DynamicIsland = ({
    ...
    const LINKS = [{
      ...
      icon: hov => /*#__PURE__*/(0, _jsxDevRuntime.jsxDEV)("svg", {
        width: "15",
        height: "15",
        viewBox: "0 0 24 24",
        fill: accent,
      ...
      icon: hov => /*#__PURE__*/(0, _jsxDevRuntime.jsxDEV)(GithubMark, {
        size: 15,
        fill: accent,
        style: {
          display: 'block',
    ...
    return /*#__PURE__*/(0, _jsxDevRuntime.jsxDEV)("div", {
      ...
      children: /*#__PURE__*/(0, _jsxDevRuntime.jsxDEV)("div", {
        ...
        children: [LINKS.map((link, i) => /*#__PURE__*/(0, _jsxDevRuntime.jsxDEV)("a", {
          href: link.href,
          target: "_blank",
          ...
          children: [link.icon(hoveredIdx === i), /*#__PURE__*/(0, _jsxDevRuntime.jsxDEV)("span", {
            style: {
        ...
        }, i, true)), /*#__PURE__*/(0, _jsxDevRuntime.jsxDEV)("div", {
          style: {
            width: '5px',
            height: '5px',
            borderRadius: '50%',
